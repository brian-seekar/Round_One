...
**Objective:** Analyzed 3.5 years of Kiva crowdfunding data for Rwanda to identify operational trends and forecast annual performance.
Key Contributions:
...
- **Predictive Modeling:** Built a Linear Regression model to extrapolate a 30% data gap in 2017, providing a more accurate estimation of year-over-year growth.
